...
DISTRO_INCLUDE=bash-completion,bsdextrautils,cpufrequtils,cryptsetup,chrony,dosfstools,ethtool,\
fdisk,file,findutils,less,ifupdown,iproute2,iputils-ping,iputils-tracepath,logrotate,lsof,\
man-db,mmc-utils,mtd-utils,netcat-openbsd,net-tools,openssh-server,openssh-sftp-server,\
